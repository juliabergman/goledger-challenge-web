            ...
            <div id="modal" className="modal-container">
                <form className="modal">
                    ...
                    <div className="campo-modal">
                        <label for="nome-pilotos">Nome</label>
                        <input id="nome-pilotos" className="input_modal" type="text" />
                    </div>

                    <div className="campo-modal">
                        <label for="equipe-pilotos">Equipe</label>
                        <input id="equipe-pilotos" className="input_modal" type="text" />
                    </div>
